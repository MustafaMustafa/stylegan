...
if 1:
    ...
    submit_config.run_id = 3
    train.network_snapshot_ticks = 1
    train.resume_run_id = 3

    # Dataset.
    # desc += '-ffhq';     dataset = EasyDict(tfrecord_dir='ffhq');                 train.mirror_augment = True
    desc += '-convmaps';     dataset = EasyDict(tfrecord_dir='convmaps', resolution=256, dtype='float32', dynamic_range=[-1,1]); train.mirror_augment = False
